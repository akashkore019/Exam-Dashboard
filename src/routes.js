...
const AddCategoryMaster = React.lazy(() => import('./components/addCategoryMaster'))

const CategoryMaster = React.lazy(() => import('./components/categoryMaster'))
const Addmedicinemaster = React.lazy(() => import('./components/addmedicinemaster'))
...
const routes = [
  ...
  { path: '/appointmentDetails', name: 'Appointment Details', element: AppointmentDetails },
  ...
  { path: '/addCategoryMaster', name: 'Add Category Master', element: AddCategoryMaster },
